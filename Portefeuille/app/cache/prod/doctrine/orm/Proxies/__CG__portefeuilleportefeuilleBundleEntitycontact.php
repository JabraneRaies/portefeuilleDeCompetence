...
namespace Proxies\__CG__\portefeuille\portefeuilleBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class contact extends \portefeuille\portefeuilleBundle\Entity\contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'portefeuille\\portefeuilleBundle\\Entity\\contact' . "\0" . 'id', '' . "\0" . 'portefeuille\\portefeuilleBundle\\Entity\\contact' . "\0" . 'nom', '' . "\0" . 'portefeuille\\portefeuilleBundle\\Entity\\contact' . "\0" . 'prenom', '' . "\0" . 'portefeuille\\portefeuilleBundle\\Entity\\contact' . "\0" . 'email', '' . "\0" . 'portefeuille\\portefeuilleBundle\\Entity\\contact' . "\0" . 'message', '' . "\0" . 'portefeuille\\portefeuilleBundle\\Entity\\contact' . "\0" . 'numero');
        }
